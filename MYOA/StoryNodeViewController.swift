...
class StoryNodeViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
            ...
            //Get the selected storyNode
            
            let selectStoryNode = storyNode.storyNodeForIndex(indexPath.row)

            //Get a selected storyNode from the storyboard
            ...
            //Attribute the selected storyNode to the viewController and push it
            storyNodeController.storyNode = selectStoryNode
        ...
        func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
            ...
            var selectedStoryNodeMessage = storyNode.promptForIndex(indexPath.row)
            cell.textLabel?.text = selectedStoryNodeMessage
